...
- (void)setData:(NSDictionary *) data{
    ...
    CGSize tagSize = [self sizeWithString:[data objectForKey:@"tags"] font:NJTextFont maxSize:CGSizeMake(size.width-170, MAXFLOAT)];
    ...
    CGFloat distanceY = self.cellHeight - 20;
